...
wire [31:0] ram_O1_0_nc;
wire [31:0] ram_O1_1_nc;
wire [3:0]  ram_O1_2_nc;
wire [31:0] ram_O1_3_nc;
wire [31:0] ram_O1_4_nc;
wire [3:0]  ram_O1_5_nc;
...
SRAM2RW128x32 ram_Inst_160X65_0 (
    .CE1  (gated_clk_core),
    .CSB1 (web | wa_0_0[7]),
    .WEB1 (web | wa_0_0[7]),
    .OEB1 (1'b1),
...
SRAM2RW128x32 ram_Inst_160X65_1 (
    .CE1  (gated_clk_core),
    .CSB1 (web | wa_0_0[7]),
    .WEB1 (web | wa_0_0[7]),
    .OEB1 (1'b1),
...
SRAM2RW128x4 ram_Inst_160X65_2 (
    .CE1  (gated_clk_core),
    .CSB1 (web | wa_0_0[7]),
    .WEB1 (web | wa_0_0[7]),
    .OEB1 (1'b1),
...
SRAM2RW128x32 ram_Inst_160X65_3 (
    .CE1  (gated_clk_core),
    .CSB1 (web | ~wa_0_0[7]),
    .WEB1 (web | ~wa_0_0[7]),
    .OEB1 (1'b1),
...
SRAM2RW128x32 ram_Inst_160X65_4 (
    .CE1  (gated_clk_core),
    .CSB1 (web | ~wa_0_0[7]),
    .WEB1 (web | ~wa_0_0[7]),
    .OEB1 (1'b1),
...
SRAM2RW128x4 ram_Inst_160X65_5 (
    .CE1  (gated_clk_core),
    .CSB1 (web | ~wa_0_0[7]),
    .WEB1 (web | ~wa_0_0[7]),
    .OEB1 (1'b1),
...
assign ramDataOut[64:0] = ra_0_0[7] ? {ram_O2_5[0], ram_O2_4, ram_O2_3} : {ram_O2_2[0], ram_O2_1, ram_O2_0};
