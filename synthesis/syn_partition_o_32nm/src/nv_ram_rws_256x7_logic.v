...
wire [7:0] ram_O1_0_nc; wire [7:0] ram_O2_0;
wire [7:0] ram_O1_1_nc; wire [7:0] ram_O2_1;
...
SRAM2RW128x8 ram_Inst_256X7_0 (
    .CE1  (gated_clk_core), .CSB1 (csb1_0), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 ({1'b0, Wdata[6:0]}), .O1 (ram_O1_0_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_0), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (8'b0), .O2 (ram_O2_0)
);

SRAM2RW128x8 ram_Inst_256X7_1 (
    .CE1  (gated_clk_core), .CSB1 (csb1_1), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 ({1'b0, Wdata[6:0]}), .O1 (ram_O1_1_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_1), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (8'b0), .O2 (ram_O2_1)
);

assign ramDataOut[6:0] = ra_0_0[7] ? ram_O2_1[6:0] : ram_O2_0[6:0];
