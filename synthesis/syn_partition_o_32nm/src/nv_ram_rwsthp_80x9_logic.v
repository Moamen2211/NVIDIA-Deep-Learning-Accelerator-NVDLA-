...
SRAM2RW128x16 ram_Inst_80X9 (
    ...
    .WEB2 (1'b1),
    .OEB2 (1'b0),
    .A2   ({ra_0_0[6] & !test_mode, ra_0_0[5:0]}),
    .I2   (16'b0),
    .O2   (ram_O2)
);

assign {ramDataOut[8], ramDataOut[7], ramDataOut[6], ramDataOut[5], ramDataOut[4], ramDataOut[3], ramDataOut[2], ramDataOut[1], ramDataOut[0]} = ram_O2[8:0];
