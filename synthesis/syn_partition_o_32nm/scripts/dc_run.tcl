...
# [ADDED] Enable automatic combinational loop breaking
set_host_options -max_cores 8
set compile_variables_status true
set hdlin_check_no_latch true
set timing_disable_combinational_loops true
...
# ===================================================================
# [ADDED] Breaking Combinational Loops for NVDLA SRAMs & Credit Queues
# ===================================================================
puts "${synMsgInfo} Disabling timing arcs to break loops in Credit Queues..."
set_disable_timing [get_cells -hierarchical -filter "full_name =~ *u_NV_NVDLA_mcif/*/u_cq/*"]
# ===================================================================
...
if {[shell_is_in_topographical_mode] && ${SYN_MODE} == "dcg" && ![shell_is_in_exploration_mode]} {
	set compile_command "compile_ultra -no_seq_output_inversion  -gate_clock -spg "
} elseif {[shell_is_in_topographical_mode] && ![shell_is_in_exploration_mode]} {
	set compile_command "compile_ultra -no_seq_output_inversion  -gate_clock "
} elseif {[shell_is_in_exploration_mode]} {
    set compile_command "compile_exploration  -no_seq_output_inversion -gate_clock"
}  else {
    set compile_command "compile_ultra -no_seq_output_inversion -no_autoungroup "
}
