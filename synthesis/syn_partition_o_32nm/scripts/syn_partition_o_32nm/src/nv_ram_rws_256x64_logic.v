...
wire [31:0] ram_O1_0_nc; wire [31:0] ram_O2_0;
wire [31:0] ram_O1_1_nc; wire [31:0] ram_O2_1;
wire [31:0] ram_O1_2_nc; wire [31:0] ram_O2_2;
wire [31:0] ram_O1_3_nc; wire [31:0] ram_O2_3;

wire csb1_0 = web | wa_0_0[7];
wire csb1_1 = web | !wa_0_0[7];

wire csb2_0 = reb | ra_0_0[7];
wire csb2_1 = reb | !ra_0_0[7];

SRAM2RW128x32 ram_Inst_256X64_0 (
    .CE1  (gated_clk_core), .CSB1 (csb1_0), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 (Wdata[31:0]), .O1 (ram_O1_0_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_0), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (32'b0), .O2 (ram_O2_0)
);

SRAM2RW128x32 ram_Inst_256X64_1 (
    .CE1  (gated_clk_core), .CSB1 (csb1_0), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 (Wdata[63:32]), .O1 (ram_O1_1_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_0), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (32'b0), .O2 (ram_O2_1)
);

SRAM2RW128x32 ram_Inst_256X64_2 (
    .CE1  (gated_clk_core), .CSB1 (csb1_1), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 (Wdata[31:0]), .O1 (ram_O1_2_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_1), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (32'b0), .O2 (ram_O2_2)
);

SRAM2RW128x32 ram_Inst_256X64_3 (
    .CE1  (gated_clk_core), .CSB1 (csb1_1), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[6:0]), .I1 (Wdata[63:32]), .O1 (ram_O1_3_nc),
    .CE2  (gated_clk_core), .CSB2 (csb2_1), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[6:0]), .I2 (32'b0), .O2 (ram_O2_3)
);

assign ramDataOut[63:0] = ra_0_0[7] ? {ram_O2_3, ram_O2_2} : {ram_O2_1, ram_O2_0};
