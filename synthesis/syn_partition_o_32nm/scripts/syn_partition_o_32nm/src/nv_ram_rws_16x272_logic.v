...
wire [31:0] ram_O1_nc_0; wire [31:0] ram_O2_0;
wire [31:0] ram_O1_nc_1; wire [31:0] ram_O2_1;
wire [31:0] ram_O1_nc_2; wire [31:0] ram_O2_2;
wire [31:0] ram_O1_nc_3; wire [31:0] ram_O2_3;
wire [31:0] ram_O1_nc_4; wire [31:0] ram_O2_4;
wire [31:0] ram_O1_nc_5; wire [31:0] ram_O2_5;
wire [31:0] ram_O1_nc_6; wire [31:0] ram_O2_6;
wire [31:0] ram_O1_nc_7; wire [31:0] ram_O2_7;
wire [15:0] ram_O1_nc_8; wire [15:0] ram_O2_8;

SRAM2RW16x32 ram_Inst_16X272_0 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[31:0]), .O1 (ram_O1_nc_0),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_0)
);

SRAM2RW16x32 ram_Inst_16X272_1 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[63:32]), .O1 (ram_O1_nc_1),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_1)
);

SRAM2RW16x32 ram_Inst_16X272_2 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[95:64]), .O1 (ram_O1_nc_2),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_2)
);

SRAM2RW16x32 ram_Inst_16X272_3 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[127:96]), .O1 (ram_O1_nc_3),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_3)
);

SRAM2RW16x32 ram_Inst_16X272_4 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[159:128]), .O1 (ram_O1_nc_4),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_4)
);

SRAM2RW16x32 ram_Inst_16X272_5 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[191:160]), .O1 (ram_O1_nc_5),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_5)
);

SRAM2RW16x32 ram_Inst_16X272_6 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[223:192]), .O1 (ram_O1_nc_6),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_6)
);

SRAM2RW16x32 ram_Inst_16X272_7 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[255:224]), .O1 (ram_O1_nc_7),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (32'b0), .O2 (ram_O2_7)
);

SRAM2RW16x16 ram_Inst_16X272_8 (
    .CE1  (gated_clk_core), .CSB1 (web), .WEB1 (web), .OEB1 (1'b1), .A1 (wa_0_0[3:0]), .I1 (Wdata[271:256]), .O1 (ram_O1_nc_8),
    .CE2  (gated_clk_core), .CSB2 (reb), .WEB2 (1'b1), .OEB2 (1'b0), .A2 (ra_0_0[3:0]), .I2 (16'b0), .O2 (ram_O2_8)
);

assign ramDataOut[271:0] = {ram_O2_8, ram_O2_7, ram_O2_6, ram_O2_5, ram_O2_4, ram_O2_3, ram_O2_2, ram_O2_1, ram_O2_0};
