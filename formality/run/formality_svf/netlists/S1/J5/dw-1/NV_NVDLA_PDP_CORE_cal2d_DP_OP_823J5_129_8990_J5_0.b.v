...
module NV_NVDLA_PDP_CORE_cal2d_DP_OP_823J5_129_8990_J5_0 ( I1, I2, O1, O2 );
  input [2:0] I1;
  input [2:0] I2;
  output [3:0] O1;
  output O2;
  ...
  XNOR2X1_RVT U32 ( .A1(n31), .A2(n46), .Y(n40) );
  OR2X1_RVT U33 ( .A1(n46), .A2(n31), .Y(n41) );
  HADDX1_RVT U34 ( .A0(n45), .B0(n32), .SO(n39), .C1(n31) );
